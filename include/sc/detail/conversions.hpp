...
namespace sc::detail {
    template<typename CharT, int SizeT>
    ...
    template<
        ...
        typename BaseTypeT>
    [[nodiscard]] constexpr static_string<char, 65> integral_to_string(
        IntegralTypeT value,
        BaseTypeT base,
        bool uppercase
    ) {
    ...
    constexpr static std::string_view type_as_string() {
