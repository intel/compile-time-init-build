...
namespace sc {
    ...
    constexpr OutputIter copy(InputIter in_iter, InputIter in_end, OutputIter out_iter) {
    ...
    [[nodiscard]] constexpr char * format_field(
        std::string_view field,
        std::integral_constant<EnumTypeT, ValueT>,
        char * out
    ) {
    ...
    template<
        typename IntegralTypeT,
        IntegralTypeT ValueT,
    ...
    template<
        ...
        CharT... chars,
        typename ArgsTupleT>
    struct is_lazy_format_string<lazy_string_format<string_constant<CharT, chars...>, ArgsTupleT>> : public std::integral_constant<bool, true> {};
    ...
    [[nodiscard]] constexpr auto format(
        string_constant<CharT, chars...> fmtStr,
        ArgTs... args
    ) {
