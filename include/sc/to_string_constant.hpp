...
namespace sc {
    ...
    [[nodiscard]] constexpr auto to_string_constant(
        ...
        return create<detail::IntegralToString<IntegralTypeT, ValueT, BaseTypeT, BaseT, UppercaseT>>();
    }
    ...
    [[nodiscard]] constexpr auto to_string_constant(
        std::integral_constant<EnumTypeT, ValueT> const &
    ) {
    ...
    template<
        ...
        CharT... chars>
    [[nodiscard]] constexpr auto to_string_constant(
        string_constant<CharT, chars...> str
    ) {
        return str;
    }
}