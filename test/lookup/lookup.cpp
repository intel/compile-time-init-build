...
TEST_CASE("a lookup with no entries", "[lookup]") {
    constexpr auto lookup = make<input<uint32_t, uint32_t, 0>>();
...
TEST_CASE("a lookup with no entries and non-zero default", "[lookup]") {
    constexpr auto lookup = make<input<uint32_t, uint32_t, 5>>();
...
TEST_CASE("a linear lookup with non-integer values", "[lookup]") {
    ...
    constexpr auto lookup = linear_search_lookup<25>::make<
        input<uint32_t, bitset<32>, bitset<32>{}, entry{42u, bitset<32>{0}},
...
TEST_CASE("a lookup with some entries", "[lookup]") {
    constexpr auto lookup = make<input<uint32_t, uint32_t, 0, entry{0u, 13u},
                                       entry{6u, 42u}, entry{89u, 10u}>>();
...
TEST_CASE("a lookup with some entries and non-zero default", "[lookup]") {
    constexpr auto lookup = make<input<uint32_t, uint32_t, 5, entry{1u, 13u},
                                       entry{6u, 42u}, entry{89u, 10u}>>();
...
TEST_CASE("a lookup with some sequential entries", "[lookup]") {
    constexpr auto lookup =
        make<input<uint32_t, uint32_t, 1, entry{0u, 13u}, entry{1u, 42u},
                   entry{2u, 10u}, entry{3u, 76u}, entry{4u, 25u},
                   entry{5u, 82u}, entry{6u, 18u}, entry{7u, 87u},
                   entry{8u, 55u}, entry{9u, 11u}>>();
