...
TEST_CASE("union less tiny sets with same types", "[set]") {
    auto t = cib::set_union(cib::make_tuple(A{}, B{}, C{}),
                            cib::make_tuple(A{}, B{}, C{}));

    REQUIRE((
        std::is_same_v<decltype(t), decltype(cib::make_tuple(A{}, B{}, C{}))>));
}

TEST_CASE("intersection empty sets", "[set]") {
    auto t = cib::set_intersection(cib::make_tuple(), cib::make_tuple());

    REQUIRE((std::is_same_v<decltype(t), decltype(cib::make_tuple())>));
}

TEST_CASE("intersection tiny sets, same", "[set]") {
    auto t = cib::set_intersection(cib::make_tuple(A{}), cib::make_tuple(A{}));

    REQUIRE((std::is_same_v<decltype(t), decltype(cib::make_tuple(A{}))>));
}

TEST_CASE("intersection tiny sets, different", "[set]") {
    auto t = cib::set_intersection(cib::make_tuple(A{}), cib::make_tuple(B{}));
...
TEST_CASE("intersection less tiny sets with same types", "[set]") {
    auto t = cib::set_intersection(cib::make_tuple(A{}, B{}, C{}),
                                   cib::make_tuple(A{}, B{}, C{}));
...
TEST_CASE("difference empty sets", "[set]") {
    auto t = cib::set_difference(cib::make_tuple(), cib::make_tuple());

    REQUIRE((std::is_same_v<decltype(t), decltype(cib::make_tuple())>));
}

TEST_CASE("difference one empty set", "[set]") {
    auto t = cib::set_difference(cib::make_tuple(A{}), cib::make_tuple());

    REQUIRE((std::is_same_v<decltype(t), decltype(cib::make_tuple(A{}))>));
}

TEST_CASE("difference other empty set", "[set]") {
    auto t = cib::set_difference(cib::make_tuple(), cib::make_tuple(A{}));
...
TEST_CASE("difference first item", "[set]") {
    auto t =
        cib::set_difference(cib::make_tuple(A{}, B{}), cib::make_tuple(A{}));
...
TEST_CASE("difference last item", "[set]") {
    auto t =
        cib::set_difference(cib::make_tuple(A{}, B{}), cib::make_tuple(B{}));
...
TEST_CASE("symmetric difference empty sets", "[set]") {
    auto t =
        cib::set_symmetric_difference(cib::make_tuple(), cib::make_tuple());
...
TEST_CASE("symmetric difference left empty set", "[set]") {
    auto t =
        cib::set_symmetric_difference(cib::make_tuple(), cib::make_tuple(A{}));
...
TEST_CASE("symmetric difference right empty set", "[set]") {
    auto t =
        cib::set_symmetric_difference(cib::make_tuple(A{}), cib::make_tuple());

    REQUIRE((std::is_same_v<decltype(t), decltype(cib::make_tuple(A{}))>));
}

TEST_CASE("symmetric difference both same", "[set]") {
    auto t = cib::set_symmetric_difference(cib::make_tuple(A{}),
                                           cib::make_tuple(A{}));
