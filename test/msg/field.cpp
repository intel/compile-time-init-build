...
using TestField32BitUnaligned8 =
    field<decltype("TestField32BitUnaligned8"_sc), 0, 39, 8, std::uint32_t>;

using TestField32BitUnaligned16 =
    field<decltype("TestField32BitUnaligned16"_sc), 0, 47, 16, std::uint32_t>;

using TestField32BitUnaligned24 =
    field<decltype("TestField32BitUnaligned24"_sc), 0, 55, 24, std::uint32_t>;

using TestField48BitUnaligned16 =
    field<decltype("TestField48BitUnaligned16"_sc), 0, 63, 16, std::uint64_t>;

using TestField64BitAligned =
    field<decltype("TestField64BitAligned"_sc), 0, 63, 0, std::uint64_t>;

using TestField64BitUnaligned8 =
    field<decltype("TestField64BitUnaligned8"_sc), 0, 71, 8, std::uint64_t>;

using TestField64BitUnaligned16 =
    field<decltype("TestField64BitUnaligned16"_sc), 0, 79, 16, std::uint64_t>;

using TestField64BitUnaligned24 =
    field<decltype("TestField64BitUnaligned24"_sc), 0, 87, 24, std::uint64_t>;
